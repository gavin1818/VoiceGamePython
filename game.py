...
class VoiceGame(cocos.layer.ColorLayer):
    ...
    def update(self, dt):
        # 读入NUM_SAMPLES个取样
        string_audio_data = self.stream.read(self.NUM_SAMPLES,exception_on_overflow = False)
...
cocos.director.director.init(caption="Journey of Sally")
